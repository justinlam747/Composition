...
import type { DirectorDecision, DirectorExecution, DirectorInput, DirectorProposal, DirectorTurn } from './director';
...
export const api = {
  ...
  saveObject: (object: ObjectSpec | SceneObject) => request<SavedObject>('/objects', json({ name: object.name, kind: object.kind, dimensions: object.dimensions, scale: object.scale, referenceAssetIds: object.referenceAssetIds, geometry: object.geometry })),
