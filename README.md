...
- Double-click a block, or choose **Edit keyframes**, to see its internal keys. Move keys and choose **Smooth**, **Linear**, **Ease in**, or **Ease out**. **All blocks** returns to the scene timeline.
